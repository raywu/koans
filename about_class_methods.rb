...
class AboutClassMethods < EdgeCase::Koan
  ...
  def test_classes_and_instances_do_not_share_instance_variables
    ...
    assert_equal nil, Dog.name # originally assert @name, but it really is nil because @name just passes whatever value it represents
  end
  ...
  def test_self_while_inside_class_is_class_object_not_instance # seems like an important concept here ...
  ...
  class Dog
    class << self # wow never seen this
  ...
  #
  # Answer: this feels like a syntax difference; need to find out
